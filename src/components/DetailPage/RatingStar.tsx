    ...
    return (
        <>
            <div className="flex items-center mb-3">
                <div className='group relative flex items-center hover:cursor-pointer duration-300'>
                    ...
                    <span
                        className="absolute z-10 hidden group-hover:flex left-1 top-2 -translate-x-32 translate-y-12 shadow-lg w-96 px-2 py-1 bg-white rounded-lg text-center text-black text-sm after:content-[''] after:absolute after:left-1/2 after:-top-4 after:translate-x-1/2 after:border-8 after:border-x-transparent after:border-t-transparent after:border-b-white">
                        <StatRating /></span>
                </div>
                <p className="ml-2 text-sm font-medium text-[#316aff] dark:text-white"><a href="">1,805 ratings</a> <span className='text-black'>|</span><a href=""> 223 answered questions</a></p>
            </div>
        </>
    )
}
